...
| `labels` _object (keys:string, values:string)_ | Labels are additional labels to add to components.<br />If labels are nested, the innermost nested label will take preference. |  | Optional: \{\} <br /> |
