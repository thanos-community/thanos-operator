...
var _ = Describe("ThanosReceive Controller", func() {
	Context("When reconciling a resource", func() {
		...
		thanosreceive := &monitoringthanosiov1alpha1.ThanosReceive{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind ThanosReceive")
			err := k8sClient.Get(ctx, typeNamespacedName, thanosreceive)
