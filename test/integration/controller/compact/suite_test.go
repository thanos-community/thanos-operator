...
// Package compact runs the ThanosCompact controller's envtest specs in their own test
...
func TestThanosCompact(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ThanosCompact Controller Suite")
}
