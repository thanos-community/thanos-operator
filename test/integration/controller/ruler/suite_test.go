...
// Package ruler runs the ThanosRuler controller's envtest specs in their own test
...
func TestThanosRuler(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ThanosRuler Controller Suite")
}
