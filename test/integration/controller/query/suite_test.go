...
// Package query runs the ThanosQuery controller's envtest specs in their own test
...
func TestThanosQuery(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ThanosQuery Controller Suite")
}
