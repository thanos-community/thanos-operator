...
Usage of ./bin/manager:
  -enable-feature value
    	Experimental feature to enable. Repeat for multiple features. Available features: service-monitor, prometheus-rule, kube-resource-sync, otel-sidecar, volume-resize, server-tls.
  -enable-http2
