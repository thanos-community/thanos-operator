...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TSDBState) DeepCopyInto(out *TSDBState) {
	*out = *in
	if in.Stateful != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TSDBState.
func (in *TSDBState) DeepCopy() *TSDBState {
	if in == nil {
		return nil
	}
	out := new(TSDBState)
