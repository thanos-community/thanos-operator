...
func (in *IngesterHashringSpec) DeepCopyInto(out *IngesterHashringSpec) {
	*out = *in
	...
	if in.MaxUnavailableReplicas != nil {
		in, out := &in.MaxUnavailableReplicas, &out.MaxUnavailableReplicas
		*out = new(int32)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RulerMode) DeepCopyInto(out *RulerMode) {
	*out = *in
	if in.Stateful != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RulerMode.
func (in *RulerMode) DeepCopy() *RulerMode {
	if in == nil {
		return nil
	}
	out := new(RulerMode)
...
func (in *ThanosRulerSpec) DeepCopyInto(out *ThanosRulerSpec) {
	*out = *in
	...
	in.RulerMode.DeepCopyInto(&out.RulerMode)
