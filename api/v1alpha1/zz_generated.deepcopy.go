...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueryFederationConfig) DeepCopyInto(out *QueryFederationConfig) {
	*out = *in
	if in.DownstreamQueryStoreAPISelector != nil {
		in, out := &in.DownstreamQueryStoreAPISelector, &out.DownstreamQueryStoreAPISelector
	...
	if in.TSDBExternalLabelSelector != nil {
		in, out := &in.TSDBExternalLabelSelector, &out.TSDBExternalLabelSelector
		*out = new([]SelectorRelabelConfig)
		if **in != nil {
			in, out := *in, *out
			*out = make([]SelectorRelabelConfig, len(*in))
			copy(*out, *in)
		}
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QueryFederationConfig.
func (in *QueryFederationConfig) DeepCopy() *QueryFederationConfig {
	if in == nil {
		return nil
	}
	out := new(QueryFederationConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RuleTenancyConfig) DeepCopyInto(out *RuleTenancyConfig) {
	*out = *in
	if in.EnforcedTenantIdentifier != nil {
		in, out := &in.EnforcedTenantIdentifier, &out.EnforcedTenantIdentifier
		*out = new(string)
		**out = **in
	}
	if in.TenantSpecifierLabel != nil {
		in, out := &in.TenantSpecifierLabel, &out.TenantSpecifierLabel
		*out = new(string)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SelectorRelabelConfig) DeepCopyInto(out *SelectorRelabelConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SelectorRelabelConfig.
func (in *SelectorRelabelConfig) DeepCopy() *SelectorRelabelConfig {
	if in == nil {
		return nil
	}
	out := new(SelectorRelabelConfig)
...
func (in *ThanosCompactSpec) DeepCopyInto(out *ThanosCompactSpec) {
	*out = *in
	...
	if in.VerticalCompactionConfig != nil {
		in, out := &in.VerticalCompactionConfig, &out.VerticalCompactionConfig
		*out = new(VerticalCompactionConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Paused != nil {
...
func (in *ThanosQuerySpec) DeepCopyInto(out *ThanosQuerySpec) {
	*out = *in
	...
	if in.QueryFederation != nil {
		in, out := &in.QueryFederation, &out.QueryFederation
		*out = new(QueryFederationConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerticalCompactionConfig) DeepCopyInto(out *VerticalCompactionConfig) {
	*out = *in
	if in.ReplicaLabels != nil {
		in, out := &in.ReplicaLabels, &out.ReplicaLabels
		*out = make([]string, len(*in))
	...
	if in.DeduplicationFunc != nil {
		in, out := &in.DeduplicationFunc, &out.DeduplicationFunc
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerticalCompactionConfig.
func (in *VerticalCompactionConfig) DeepCopy() *VerticalCompactionConfig {
	if in == nil {
		return nil
	}
	out := new(VerticalCompactionConfig)
