...
func (in *QueryFederationConfig) DeepCopyInto(out *QueryFederationConfig) {
	*out = *in
	if in.QueryAsStoreAPILabelSelector != nil {
		in, out := &in.QueryAsStoreAPILabelSelector, &out.QueryAsStoreAPILabelSelector
	...
	if in.TSDBSelector != nil {
		in, out := &in.TSDBSelector, &out.TSDBSelector
